                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" role="tabpanel" id="tab-1">
                            ...
                            <div class="row">
                                <div class="col-xl-12 tour-package-left-area">
                                    <h3 class="tour-package-heading" style="font-family: 'Titillium Web', sans-serif;">
                                        Things to do in {{ $destination->title }}</h3>
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12 destination-thingstodo-img-area">
                                            @if (!empty($activities))
                                                <div class="grid">
                                                    @php
                                                        $isFirst = true;
                                                    ...
                                                    @endphp
                                                    {{-- @foreach ($activities->random(5) as $activity) --}}
                                                    @foreach ($__activities as $activity)
                                                        <div class="grid-item{{ $isFirst ? ' grid-item--width2' : '' }}">
                                                            <img class="img-fluid"
                                                                src="{{ imageUrl($activity->image, ['w' => $isFirst ? '570' : '285', 'h' => $isFirst ? '570' : '285', 'fit' => 'crop']) }}">
                                                            <div class="text-center destination-package-text-area"
                                                                ...
                                                                <a class="btn btn-lg text-uppercase findmore-white"
                                                                    role="button"
                                                                    style="font-family: 'Titillium Web', sans-serif;"
                                                                    href="{{ route('site.city-activity', $activity->slug) }}">Find
                                                                    Out More</a>
                                                            </div>
                                                        </div>
                                                        @php
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <a class="btn btn-lg text-uppercase destination-findmore-button"
                                        id="hdest-switchto-more-tab" role="button" href="#">Find out more things to
                                        do in {{ $destination->title }}</a>
                                </div>
                            </div>
                        </div>
